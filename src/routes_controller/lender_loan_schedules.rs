...
use crate::contract::lender_schedule::{Loan,Payment,Ledger};
...
pub async fn lender_loan_schedules(Extension(state): Extension<Arc<State>>,Path(product_id): Path<u32>)->impl IntoResponse{
